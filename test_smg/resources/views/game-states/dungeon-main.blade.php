{{-- Dungeon State - Main Area: Location Progress and Movement System (Road Template Base) --}}

<div class="road-main">
    {{-- Current Position and Progress --}}
    <div class="position-info">
        <h3>🏰 {{ $currentLocation->name ?? '' }}</h3>
        <p class="location-type">ダンジョンを探索しています</p>
        ...
        <div class="road-progress">
            ...
            <div class="progress-info">
                <span class="start-point">入口</span>
                <span class="end-point">奥地</span>
            </div>
        </div>
    </div>
        ...
        <div class="dice-controls">
            ...
            <div class="dice-options">
                ...
                <label class="toggle-label">
                    ...
                    <span class="toggle-text">⚡ 自動探索</span>
                </label>
            </div>
        </div>
        ...
        <div class="branch-options">
            <button class="branch-btn" onclick="selectBranch('straight')" data-direction="straight">
                ...
                <div class="branch-info">
                    <span class="branch-label">奥へ進む</span>
                    <span class="branch-destination">更に深く</span>
                </div>
            </button>
            <button class="branch-btn" onclick="selectBranch('left')" data-direction="left">
                <span class="branch-icon">⬅️</span>
                <div class="branch-info">
                    <span class="branch-label">左の道</span>
                    <span class="branch-destination">隠し通路</span>
                </div>
            </button>
            <button class="branch-btn" onclick="selectBranch('right')" data-direction="right">
                <span class="branch-icon">➡️</span>
                <div class="branch-info">
                    <span class="branch-label">右の道</span>
                    <span class="branch-destination">宝物庫</span>
                </div>
            </button>
        </div>
        
        <div class="branch-help">
            <p>💡 分岐点では通常の探索はできません。上記から進路を選択してください。</p>
        </div>
    </div>
