    ...
    <div class="row">
                    ...
                    <form action="{{ route('admin.route-connections.update', $connection->id) }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('position') is-invalid @enderror" 
                                   id="position" name="position" value="{{ old('position', $connection->position) }}" min="0">
        ...
        <div class="col-lg-4">
            <div class="card">
                ...
                <div class="card-body">
                    <p><strong>{{ $connection->sourceLocation?->name ?? 'Unknown' }}</strong></p>
                    <div class="text-center my-2">
                        <i class="fas fa-arrow-down"></i>
                    </div>
                    <p><strong>{{ $connection->targetLocation?->name ?? 'Unknown' }}</strong></p>
