...
<head>
    ...
    <title>キャラクターステータス - RPGゲーム</title>
    <style>
        :root {
            /* カラーシステム */
            --primary-500: #3b82f6;
...
<body>
    <div class="character-container">
            ...
            <div class="hp-mp-bars">
                <div class="bar-container">
                    ...
                    <div class="progress-bar">
                        <div class="progress-fill hp-bar" style="width: {{ $character->getHpPercentage() }}%"></div>
                    </div>
                </div>
        ...
        <div class="stats-grid">
            ...
            <div class="stat-section">
                ...
                <div class="stat-item">
                    ...
                    <span class="stat-value">{{ $character->max_hp }}</span>
                </div>
                <div class="stat-item">
        ...
        <div class="game-card">
            <h2 class="game-card-title">キャラクター操作</h2>
            ...
            <div class="button-group">
                ...
                <button class="btn btn-secondary" onclick="resetCharacter()">リセット</button>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        function gainExp() {
            fetch('/character/gain-experience', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content')
        ...
        function resetCharacter() {
            if (confirm('キャラクターを初期状態にリセットしますか？')) {
                fetch('/character/reset', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
                        'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content')
