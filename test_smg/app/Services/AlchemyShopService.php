...
class AlchemyShopService implements ShopServiceInterface
{
    protected ShopType $shopType;

    public function __construct()
    {
        $this->shopType = ShopType::ALCHEMY_SHOP;
    }
    ...
    public function getShopData(Shop $shop): array
    {
        return [
            ...
            'available_materials' => $this->getAvailableMaterials(),
        ];
    }
    ...
    private function performAlchemy(Player $player, array $baseItem, int $baseItemSlot, array $materialSlots, array $materialEffects): array
    {
        try {
            ...
            $customItem = CustomItem::create([
                ...
                'durability' => $customStats['final_durability'],
