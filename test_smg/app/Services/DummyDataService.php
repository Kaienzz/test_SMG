...
{
    public static function getCharacter(int $id = 1): array
    {
        $baseSp = 30;
    ...
    public static function getCharacterStatusSummary(int $id = 1): array
    {
        $character = self::getCharacter($id);
        return [
            'name' => $character['name'],
            ...
            'sp_percentage' => ($character['sp'] / $character['max_sp']) * 100,
            'is_alive' => $character['hp'] > 0,
        ];
    }

    public static function getCharacterDetailedStats(int $id = 1): array
    {
        $character = self::getCharacter($id);
        return [
            'basic_info' => [
    ...
    public static function getEquipment(int $characterId = 1): array
    {
        return [
            'character_id' => $characterId,
            'weapon_id' => null,
    ...
    public static function getEquippedItems(int $characterId = 1): array
    {
        return [
            'weapon' => null,
            'body_armor' => null,
    ...
    public static function getEquipmentTotalStats(int $characterId = 1): array
    {
        return [
            'attack' => 0,
            'defense' => 0,
    ...
    public static function getSkills(int $characterId = 1): array
    {
        return [
            [
                'id' => 1,
    ...
    public static function getActiveEffects(int $characterId = 1): array
    {
        return [
            [
                'id' => 1,
    ...
    public static function updateCharacterSp(int $characterId, int $newSp): void
    {
        // セッションベースでの更新（実装時）
